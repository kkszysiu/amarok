...
#ifndef GROOVESHARKSERVICECOLLECTION_H
#define GROOVESHARKSERVICECOLLECTION_H
...
class GroovesharkServiceCollection : public ServiceCollection
{
    Q_OBJECT
public:
    GroovesharkServiceCollection( const QString& userName );
    virtual ~GroovesharkServiceCollection();
...
#endif // GROOVESHARKSERVICECOLLECTION_H
