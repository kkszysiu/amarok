...
#ifndef GROOVESHARKALBUMDOWNLOADER_H
#define GROOVESHARKALBUMDOWNLOADER_H
...
*/
class GroovesharkAlbumDownloader: public QObject
{
Q_OBJECT
public:
    GroovesharkAlbumDownloader();
...
public slots:
     ...
     * @param url A GroovesharkDownloadInfo object containing all needed information
     */
    void downloadAlbum( GroovesharkDownloadInfo info );
...
protected:
    ...
    GroovesharkDownloadInfo m_currentAlbumInfo;
    KTempDir * m_tempDir;
