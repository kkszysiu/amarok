...
#ifndef GROOVESHARKSERVICECONFIG_H
#define GROOVESHARKSERVICECONFIG_H
...
class GroovesharkServiceConfig : public QObject
{
    Q_OBJECT
public:
    static const char *configSectionName() { return "Service_Grooveshark"; }

    GroovesharkServiceConfig();
    ~GroovesharkServiceConfig();
...
#endif // GROOVESHARKSERVICECONFIG_H
