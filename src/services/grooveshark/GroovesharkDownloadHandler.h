...
#ifndef GROOVESHARKDOWNLOADHANDLER_H
#define GROOVESHARKDOWNLOADHANDLER_H
...
/**
The main class responcible for handling of downloads from Grooveshark.com

@author Nikolaj Hald Nielsen
*/
class GroovesharkDownloadHandler : public QObject
{
Q_OBJECT
public:
    GroovesharkDownloadHandler();
    ~GroovesharkDownloadHandler();
    ...
    */
   void downloadAlbum( Meta::GroovesharkAlbum * album );
...
private:
    ...
    /**
     * This function saves the xml download info received from Grooveshark.com after a
     ...
     * directory in the sub folder grooveshark.com/purchases. The name of each info file
