...
GroovesharkRedownloadDialog::GroovesharkRedownloadDialog(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
: QDialog(parent, fl)
{
    setObjectName( name );
    setModal( modal );
...
GroovesharkRedownloadDialog::~GroovesharkRedownloadDialog()
{
}

void GroovesharkRedownloadDialog::setRedownloadItems( const QStringList &items )
{
...
void GroovesharkRedownloadDialog::setRedownloadItems( QList<GroovesharkDownloadInfo> previousPurchases )
{
    m_infoMap.clear();
    
    foreach( const GroovesharkDownloadInfo &prevPurchase, previousPurchases )
    {
...
void GroovesharkRedownloadDialog::redownload( )
{
...
void GroovesharkRedownloadDialog::reject( )
{
    hide();
    emit(cancelled());
}

void GroovesharkRedownloadDialog::selectionChanged( )
{
...
#include "GroovesharkRedownloadDialog.moc"
