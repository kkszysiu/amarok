...
GroovesharkDownloadDialog::GroovesharkDownloadDialog( QWidget *parent, Qt::WFlags fl )
    : QDialog( parent, fl )
{
    setupUi(this);
...
GroovesharkDownloadDialog::~GroovesharkDownloadDialog()
{
}


void GroovesharkDownloadDialog::downloadButtonClicked( )
{
    ...
    KConfigGroup config = Amarok::config( "Service_Grooveshark" );
...
void GroovesharkDownloadDialog::setDownloadInfo( GroovesharkDownloadInfo info )
{
...
#include "GroovesharkDownloadDialog.moc"
