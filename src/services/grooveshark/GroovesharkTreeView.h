...
#ifndef GROOVESHARKTREEVIEW_H
#define GROOVESHARKTREEVIEW_H
...
class GroovesharkTreeView : public Amarok::PrettyTreeView
{
    Q_OBJECT

public:
    GroovesharkTreeView ( QWidget* parent = 0 );
    ~GroovesharkTreeView();
