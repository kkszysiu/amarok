...
GroovesharkAlbumDownloader::GroovesharkAlbumDownloader()
    : QObject()
...
void
GroovesharkAlbumDownloader::downloadAlbum( GroovesharkDownloadInfo info )
{
    DEBUG_BLOCK
    ...
    {
        msgText = i18n( "Downloading '%1' by %2 from Grooveshark.com", info.albumName(), info.artistName() );
    }
    else
    {
        msgText = i18n( "Downloading album from Grooveshark.com" );
    }
...
void
GroovesharkAlbumDownloader::albumDownloadComplete( KJob * downloadJob )
{
    DEBUG_BLOCK
    ...
    {
        Amarok::Components::logger()->shortMessage( i18n( "Grooveshark download seems to have failed. Cannot read zip file" ) );
    ...
    Amarok::Components::logger()->shortMessage( i18n( "Uncompressing Grooveshark.com download..." ) );
...
void
GroovesharkAlbumDownloader::albumDownloadAborted( )
{
    DEBUG_BLOCK
...
#include "GroovesharkAlbumDownloader.moc"
