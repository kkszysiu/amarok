...
#ifndef GROOVESHARKDATABASEWORKER_H
#define GROOVESHARKDATABASEWORKER_H
...
class GroovesharkDatabaseWorker : public ThreadWeaver::Job
{
    Q_OBJECT
public:
    GroovesharkDatabaseWorker();
...
signals:
    ...
    void gotAlbumBySku( Meta::GroovesharkAlbum * album );
