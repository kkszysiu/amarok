...
#ifndef GROOVESHARKURLRUNNER_H
#define GROOVESHARKURLRUNNER_H
...
*/
class GroovesharkUrlRunner : public QObject, public AmarokUrlRunnerBase
{
    Q_OBJECT
public:
    GroovesharkUrlRunner();

    virtual ~GroovesharkUrlRunner();
